...
export const routes: Route[] = [
  ...
  { path: "/courses/:id", component: CourseDetails, pageName: "Course Details" },
  { path: "/categories", component: Categories, pageName: "Categories" },
  { path: "/categories/:id", component: CategoryDesc, pageName: "Category Description" },
  { path: "/instructors", component: Instructors, pageName: "Instructors" },
  { path: "/instructors/:id", component: InstructorProfile, pageName: "Instructor Profile" },
  ...
  { path: "/education-shop", component: EducationShop, pageName: "Education Shop" },
  ...
  { path: "/auth/student-registration", component: StudentRegistration, pageName: "Student Registration" },
  { path: "/auth/instructor-registration", component: InstructorRegistration, pageName: "Instructor Registration" },
